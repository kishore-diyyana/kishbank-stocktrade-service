...
public class ApplicationTests {
    ...
    public void testTradeCreationWithValidData() throws Exception {
        ...
        StockTrade actualRecord = om.readValue(mockMvc.perform(post("/api/trade-service/trades")
        ...
        actualRecord = om.readValue(mockMvc.perform(post("/api/trade-service/trades")
                .contentType("application/json")
                .content(om.writeValueAsString(expectedRecord)))
                .andDo(print())
                .andExpect(jsonPath("$.id", greaterThan(0)))
        ...
        mockMvc.perform(post("/api/trade-service/trades")
                .contentType("application/json")
                .content(om.writeValueAsString(expectedRecord)))
                .andDo(print())
    ...
    public void testGetTrades() throws Exception {
        ...
        for (Map.Entry<String, StockTrade> kv : testData.entrySet()) {
            StockTrade response = om.readValue(mockMvc.perform(post("/api/trade-service/trades")
                    .contentType("application/json")
        ...
        //without filter
        List<StockTrade> actualRecords = om.readValue(mockMvc.perform(get("/api/trade-service/trades"))
                .andDo(print())
        ...
        actualRecords = om.readValue(mockMvc.perform(get("/api/trade-service/trades?type=buy"))
                .andDo(print())
                .andExpect(status().isOk()).andReturn().getResponse().getContentAsString(), new TypeReference<List<StockTrade>>() {
        });
        ...
        actualRecords = om.readValue(mockMvc.perform(get("/api/trade-service/trades?type=sell"))
                .andDo(print())
                .andExpect(status().isOk()).andReturn().getResponse().getContentAsString(), new TypeReference<List<StockTrade>>() {
        });
        for (int i = 0; i < expected.size(); i++) {
        ...
        mockMvc.perform(get("/api/trade-service/trades?type=boo"))
                .andDo(print())
        ...
        actualRecords = om.readValue(mockMvc.perform(get("/api/trade-service/trades?user_id=23"))
                .andDo(print())
                .andExpect(status().isOk()).andReturn().getResponse().getContentAsString(), new TypeReference<List<StockTrade>>() {
        });
        for (int i = 0; i < expected.size(); i++) {
        ...
        mockMvc.perform(get("/api/trade-service/trades?userId=" + Integer.MAX_VALUE))
                .andDo(print())
                .andExpect(jsonPath("$.*", isA(ArrayList.class)))
                .andExpect(jsonPath("$.*", hasSize(0)))
                .andExpect(status().isOk());
        ...
        actualRecords = om.readValue(mockMvc.perform(get("/api/trade-service/trades?user_id=23&type=buy"))
                .andDo(print())
                .andExpect(status().isOk()).andReturn().getResponse().getContentAsString(), new TypeReference<List<StockTrade>>() {
        });
        for (int i = 0; i < expected.size(); i++) {
        ...
        actualRecords = om.readValue(mockMvc.perform(get("/api/trade-service/trades?user_id=23&type=sell"))
                .andDo(print())
                .andExpect(status().isOk()).andReturn().getResponse().getContentAsString(), new TypeReference<List<StockTrade>>() {
        });
        for (int i = 0; i < expected.size(); i++) {
    ...
    public void testGetTradeRecordWithId() throws Exception {
        ...
        expectedRecord = om.readValue(mockMvc.perform(post("/api/trade-service/trades")
                .contentType("application/json")
                .content(om.writeValueAsString(expectedRecord)))
                .andDo(print())
                .andExpect(status().isCreated()).andReturn().getResponse().getContentAsString(), StockTrade.class);
        ...
        //for existing
        StockTrade actualRecord = om.readValue(mockMvc.perform(get("/api/trade-service/trades/" + expectedRecord.getId()))
                .andExpect(status().isOk())
                .andReturn()
                .getResponse()
        ...
        //non existing
        mockMvc.perform(get("/api/trade-service/trades/" + Integer.MAX_VALUE))
    ...
    public void testNotAllowedMethod() throws Exception {
        ...
        mockMvc.perform(put("/api/trade-service/trades/" + actualRecord.getId()))
                .andExpect(status().isMethodNotAllowed());

        mockMvc.perform(patch("/api/trade-service/trades/" + actualRecord.getId()))
                .andExpect(status().isMethodNotAllowed());

        mockMvc.perform(delete("/api/trade-service/trades/" + actualRecord.getId()))
                .andExpect(status().isMethodNotAllowed());
    }
